...
cell2_source = [
    ...
    "BATCH_SIZE = 8             # Adjusted for stable VRAM overhead\n",
    "GRADIENT_ACCUMULATION = 2  # Gradient accumulation steps (Effective batch size = 16)\n",
...
# Apply clean sources to notebook
for cell in nb.get("cells", []):
    ...
    elif "# 2. TRAINING HYPERPARAMETERS" in source_str:
        cell["source"] = cell2_source
    elif "# 3." in source_str:
...
print("Notebook train_folc_kaggle.ipynb cleaned successfully!")
