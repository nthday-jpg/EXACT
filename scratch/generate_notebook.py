...
# --- Cell 1: Package installation (Offline Mode) ---
cell1_source = [
...
# --- Cell 5: Tokenizer, Splits, Formatting ---
cell5_source = [
...
# --- Cell 6: Custom collator, JSON cleaner, and Evaluation metrics ---
cell6_source = [
...
# Create final notebook json structure
notebook_json = {
    "cells": cells,
    "metadata": {
        "kernelspec": {
...
output_notebook_path = "d:/mduy/source/repos/EXACT/src/llm/tuning/router_and_physics.ipynb"
...
print(f"Successfully generated notebook at: {output_notebook_path}")
