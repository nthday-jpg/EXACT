...
"question": "Two point charges, q1 = 4e-6 C and q2 = -6.4e-6 C, are placed at points A and B, separated by 0.2 m in air. Determine the magnitude of the electric force acting on q3 = -5e-8 C placed at point C, given that AC = 0.12 m and BC = 0.16 m.",
{
  ...
  "physics_analysis": [
    "q1 = 4e-6 C at A(0,0), q2 = -6.4e-6 C at B(0.2,0)",
    "Target q3 = -5e-8 C at C(xc,yc) with AC=0.12, BC=0.16",
    "Target unit: N"
  ],
  "algebraic_reasoning": [
    "Determine coordinates xc and yc of point C via distance constraints",
    "Construct matrix displacement and unit direction vectors",
    "Compute individual Coulomb force vectors and evaluate resultant norm"
  ],
